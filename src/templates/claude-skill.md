...
- Renderer: `@mermaid-js/mermaid-cli` (mmdc) — Puppeteer-driven Chromium running canonical `mermaid`
- Author frontmatter (`---config: theme: dark---` at the top of a `.mmd` file) wins over the workspace theme
